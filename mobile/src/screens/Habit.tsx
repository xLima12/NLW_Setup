...
export function Habit() {
    ...
    const [dayInfo, setDayInfo] = useState<DayInfoPrrops | null>(null);
    ...
    const habitsProgress = dayInfo?.possibleHabits.length
        ? generateProgressPorcentage(dayInfo.possibleHabits.length, completedHabits.length) : 0;
                ...
                })}>
                    {
                        dayInfo?.possibleHabits ? dayInfo?.possibleHabits.map(habit => (
                            <CheckBox
                                ...
                                onPress={() => handleToggleHabbit(habit.id)}
                            />
                        ))
                            : <HabitsEmpty />
                    }
